    ...
    public class MapVisualizer : MonoBehaviour
    {
        ...
        private void PlaceTowers(MapData data)
        {
            ...
            if (data.path != null && data.path.Count > 2)
            {
                ...
                SpawnTower(towerGridPos, towerPrefabs[firstIdx], "Wie¿a 1", firstTowerSceneName, toTower, fromTower);
            }
            ...
            if (data.altPath != null && data.altPath.Count > 2)
            {
                ...
                SpawnTower(towerGridPos, towerPrefabs[secondIdx], "Wie¿a 2", secondTowerSceneName, toTower, fromTower);
            }
        }
